...
const BULLETPREFAB = preload("res://node prefabs/bullet.tscn")

const ROPE_PREFAB = preload("res://node prefabs/better_rope.tscn")
const REAL_ROPE_PREFAB = preload("res://node prefabs/rope.tscn")
var current_rope
